---
name: GeneaSphere开发计划
overview: 基于《根脉云谱》需求文档，制定完整的开发计划，包括环境配置（skill/MCP安装）、Sprint阶段划分、核心任务、技术路径、里程碑和交付标准。
---
...
用户要求根据《根脉云谱（GeneaSphere）前端页面设计规范 v1.0.md》及相关需求文档，完成以下两项核心任务：
